...
st.set_page_config(page_title="TEE Housing Predictor", page_icon="🏠", layout="wide", initial_sidebar_state="expanded")
st.title("Know your house value! 🏠")
st.write('Use the sliders on the left to make the housing prediction.')
st.write('---')

# Sidebar for user inputs
with st.sidebar:
    st.title("Toggle to get your Preference")
    # Collect user input
    user_input = {
